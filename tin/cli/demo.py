...
Usage:
    tin-demo --body lunar
    tin-demo --body lunar --days 28 --emergency
    tin-demo --body mars
    tin-demo --body mars --conjunction
    tin-demo --body both --all
"""
...
def run_lunar(args):
    ...
    if args.viz:
        ...
        if args.emergency:
            try:
                viz_bundles = dtn.bundles
            except NameError:
                pass
        make_all_viz(constellation=const, bundles=viz_bundles)
...
def run_mars(args):
    ...
    const = MarsConstellation(n_polar=6, polar_alt_km=350, n_areo=2, use_aerostats=True)
...
def main():
    ...
    parser.add_argument("--viz", action="store_true", default=False,
                        help="Generate interactive Plotly HTML visualizations")
    ...
    print(f"  MIT License | github.com/toxic2040/TIN")
